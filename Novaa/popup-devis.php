...
<body>
				<div id="popup">
				<img src="images/dog-devis.jpg" class="left">
				<h1>Pour obtenir votre devis, veuillez remplir ce formulaire</h1>	
				<h2>Pour votre comptabilité ou votre création d'entreprise, Novaa vous propose des solutions adaptées à votre entreprise. Renseignez-vous, ça ne coute rien !</h2>

				<form class="formulaire" method="post" action="merci.php" target="_parent">
						<p class="intro-presta"><label for="veux-creer">
							<input type="checkbox" id="veux-creer" name="veut-creer" onclick="displayCreaOfferte();" value="oui" /><input type="hidden" value="non" name="veut-creer"> je souhaite créer mon entreprise</label> <label for="ai-salarie"><input type="checkbox" id="ai-salarie" name="ai-salarie" onclick="displaySalarie();" value="oui" /><input type="hidden" value="non" name="ai-salarie"> j'ai des salariés</label></p>
